                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="cls_reserv" value="SI">
                            <div class="col-sm-5">
                                <div class="">
                            ...
                            <div class="col-sm-2">
                                <div class="">
                                    ...
                                    <?= form_dropdown('tipop', array("LOCAL" => "LOCAL", "RECEPTIVO" => "RECEPTIVO"), $paquete->paqu_tipo, array('class' => 'form-control input-sm', "id" => "tipop")); ?>
                                </div>
                            </div>
