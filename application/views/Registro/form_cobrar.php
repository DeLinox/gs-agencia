...
<div class="modal-dialog" role="document">
    <div class="modal-content">
		<form id="frm-pago" class="form-horizontal" action="<?=base_url()?>Registro/paq_guardarCobro/<?= $paquete->id ?>" method="post">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="gridSystemModalLabel">Realizar cobro: <?= $paquete->prefijo."-".$paquete->numero." : ".$paquete->cliente ?></h4>
			</div>
			<div class="modal-body">
				<div class="alert alert-danger error hidden" role="alert">
				    ...
				    <div class="form-group">
						...
						<div class="col-sm-4"><?=form_dropdown('moneda', $moneda, $paquete->moneda,array('class' => 'form-control input-sm', "disabled" => "disabled"));?></div>
				    </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4"><?=form_input(array("name"=>"total","value"=>$paquete->total,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
						<?=form_label('<strong>Cancelado</strong>', 'cancelado',array('class' => 'col-sm-2 control-label')); ?>
						<div class="col-sm-4"><?=form_input(array("name"=>"cancelado","value"=>$paquete->cancelado,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
					</div>	
					<div class="form-group">
						<?=form_label('<strong>Saldo</strong>', 'saldo',array('class' => 'col-sm-2 control-label')); ?>
						<div class="col-sm-4"><?=form_input(array("name"=>"saldo","value"=>$paquete->total - $paquete->cancelado,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
						<div class="">
