        ...
        <div class="row page-header-title">
            ...
            <div class="col-sm-6 text-right" role="group" aria-label="...">
                ...
                <div class="dropdown" style="float: right;">
                    <a class="btn btn-sm btn-danger" type="button" href="<?= base_url() ?>Registro/reg_auxiliar">
                        <i class="glyphicon glyphicon-log-out"></i> Reservas
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <form class="ocform form-inline">
                    <div class="nosel">
                        ...
                        <div class="form-group">
                            <?php echo form_dropdown('contacto',"", '', array('class' => 'form-control','id' => 'contacto')); ?>
                        </div>
                        <div class="form-group">
