        ...
        <div class="row page-header-content">
            ...
            <form class="ocform form-inline">
				<div class="nosel">
					...
					<div class="form-group">
						<?= form_dropdown('estado', array(""=>'* Estado', 'SI' => 'Pagado', 'NO' => 'Credito'), '', array('class' => 'form-control input-sm', 'id' => 'estado')); ?>
					</div>
		                        <div class="form-group">
						<?= form_dropdown('moneda', $moneda, '', array('class' => 'form-control input-sm', "id" => "moneda")); ?>
		                        </div>
					<div class="form-group">
        ...
        <div class="col-md-12">
				...
				<div class="row hidden">
					<div class="col-sm-6">
						...
						<table class="table table-striped table-bordered" id="tbl-resumen">
						    <thead>
						    	<th></th>
						    	<th>SUMA</th>
						    </thead>
