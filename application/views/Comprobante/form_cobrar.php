...
<div class="modal-dialog" role="document">
    <div class="modal-content">
		<form id="frm-pago" class="form-horizontal" action="<?=base_url()?>Comprobante/guardar_cobro/<?= $comprobante->id ?>" method="post">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="gridSystemModalLabel">Realizar cobro: <?= $comprobante->numero." - ".$comprobante->cliente ?></h4>
			</div>
			<div class="modal-body">
				<div class="alert alert-danger error hidden" role="alert">
				    ...
				    <div class="form-group">
						...
						<div class="col-sm-4"><?=form_dropdown('moneda', $moneda, $comprobante->moneda,array('class' => 'form-control input-sm', "disabled" => "disabled"));?></div>
				    </div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4"><?=form_input(array("name"=>"total","value"=>$comprobante->total,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
						<?=form_label('<strong>Cancelado</strong>', 'cancelado',array('class' => 'col-sm-2 control-label')); ?>
						<div class="col-sm-4"><?=form_input(array("name"=>"cancelado","value"=>$comprobante->cancelado,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
					</div>	
					<div class="form-group">
						<?=form_label('<strong>Saldo</strong>', 'saldo',array('class' => 'col-sm-2 control-label')); ?>
						<div class="col-sm-4"><?=form_input(array("name"=>"saldo","value"=>$comprobante->total - $comprobante->cancelado,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
						<div class="">
