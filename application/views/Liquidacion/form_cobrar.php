...
<div class="modal-dialog" role="document">
    <div class="modal-content">
		<form id="frm-pago" class="form-horizontal" action="<?=base_url()?>Liquidacion/guardar_cobro/<?= $liquidacion->id ?>" method="post">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="gridSystemModalLabel">Realizar cobro: LIQ N° <?= $liquidacion->numero." - ".$liquidacion->cliente ?></h4>
			</div>
			<div class="modal-body">
				<div class="alert alert-danger error hidden" role="alert">
				    ...
				    <div class="form-group">
						...
						<div class="col-sm-4"><?=form_dropdown('moneda', $moneda, $liquidacion->moneda,array('class' => 'form-control input-sm', "disabled" => "disabled"));?>
						</div>
				    </div>
					<div class="form-group hidden">
						...
						<div class="col-sm-3"><?=form_input(array("name"=>"numero","class"=>"form-control input-sm","placeholder" =>"Número"));?>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4"><?=form_input(array("name"=>"saldo","value"=>$liquidacion->total - $liquidacion->cancelado,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?>
						</div>
						<div class="">
