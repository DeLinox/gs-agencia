<?php echo '<?xml version="1.0" encoding="utf-8" standalone="no"?>' ?><CreditNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" 
...
<?php endif; ?>
  ...
  <cbc:CreditedQuantity unitCode="<?php echo $detalle['unidadMedida']; ?>"><?php echo $detalle['cantItem']; ?></cbc:CreditedQuantity>
