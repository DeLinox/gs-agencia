			...
			<div class="modal-body">
				<div class="alert alert-danger error hidden" role="alert">
					...
					<div class="form-group">
						<?=form_label('<strong>Cuenta</strong>', 'tipo_pago',array('class' => 'col-sm-2 control-label')); ?>
						<div class="col-sm-4"><?=form_dropdown('tipo_pago', $tipo_pago,'',array('class' => 'form-control input-sm'));?></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4"><?=form_input(array("name"=>"total","value"=>$venta->vent_total,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4"><?=form_input(array("name"=>"fecha","value"=>"","class"=>"form-control input-sm fecha"));?></div>
						-->
						<?=form_label('<strong>Fecha</strong>', 'fecha',array('class' => 'col-sm-2 control-label')); ?>
						<div class="col-sm-4">
