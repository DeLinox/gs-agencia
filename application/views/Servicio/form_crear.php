    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div>
                    ...
                    <?= form_dropdown('categoria', $producto->cate_options, $producto->prod_cate_id, array("onchange"=>"upd_prd(this.name)", 'class' => 'form-control input-sm')); ?>
                </div>
                <div>
                    <?= form_label('<strong>Tipo</strong>', 'tipo', array('class' => 'control-label')); ?>
                    <?= form_dropdown('tipo', array('PRODUCTO'=>'PRODUCTO','SERVICIO'=>'SERVICIO','HABITACION' => 'HABITACION'), $producto->prod_tipo, array('class' => 'form-control input-sm')); ?>
                </div>
                <div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= form_input(array("name" => "valor", "id" => "prod-valor","onchange"=>"upd_prd(this.name)", "value" => $producto->prod_valor, "class" => "form-control input-sm")); ?>
                    </div>
                    <div class="col-md-6">
                        <?= form_label('<strong>Precio</strong>', 'precio', array('class' => 'control-label')); ?>
                        <?= form_input(array("name" => "precio", "id" => "prod-precio","onchange"=>"upd_prd(this.name)", "value" => $producto->prod_precio, "class" => "form-control input-sm")); ?>
                    </div>
                </div>
                <div>
