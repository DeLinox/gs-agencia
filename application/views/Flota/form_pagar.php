...
<div class="modal-dialog " role="document">
    <div class="modal-content">
		<form id="frm-pago" class="form-horizontal" action="<?=base_url()?>flota/guardar_pago/<?= $orde->sepr_id ?>" method="post">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-3"><?=form_input(array("name"=>"numero","class"=>"form-control input-sm","placeholder" =>"N&uacute;mero"));?>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><?=form_input(array("name"=>"total","value"=>$orde->sepr_combu_total,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4"><?=form_input(array("name"=>"saldo","value"=>$orde->sepr_combu_total - $orde->sepr_pagado,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?>
					</div>
				</div>
				
				<div class="form-group">
					<?=form_label('<strong>Observaci&oacute;n</strong>', 'observacion',array('class' => 'col-sm-2 control-label')); ?>
					<div class="col-sm-8">
