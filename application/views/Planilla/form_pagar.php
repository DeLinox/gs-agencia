...
<div class="modal-dialog" role="document">
    <div class="modal-content">
		<form id="frm-pago" class="form-horizontal" action="<?=base_url()?>Planilla/plan_guardarPago/<?= $plan->plan_id ?>" method="post">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="gridSystemModalLabel">Pagar a: <?= $plan->nombres ?></h4>
			</div>
			<div class="modal-body">
				<div class="alert alert-danger error hidden" role="alert">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
	                        <div class='input-group'>
	                            ...
	                            <input type='text' name="codigo-cuen" class="form-control"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-4"><?=form_input(array("name"=>"total","value"=>$plan->neto,"class"=>"form-control input-sm", 'readonly' => 'readonly'));?></div>
					</div>	
					<div class="form-group">
