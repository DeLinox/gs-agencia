<div id="page-wrapper" class="page-filter">
    <div class="page-header col-md-12">
        ...
        <div class="row page-header-content">
            <div class="col-md-12">
                <form class="ocform form-inline" action="<?= base_url() ?>Planilla/reporte_excelPeriodos" method="POST">
                    <div class="nosel">
                        <div class="form-group pull-right">
                            <a href="<?= base_url() ?>Planilla/peri_crear" class="btn btn-sm btn-primary registrar" type="button" title="Crear Periodo">
                                <span class="glyphicon glyphicon-list"></span> Registrar Periodo
                            </a>
