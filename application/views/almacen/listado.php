    ...
    <div class="page-header col-md-12">
        <div class="row page-header-title">
            ...
            <div class="col-sm-6 text-right" role="group" aria-label="...">
				<a href="<?php echo base_url() ?>Almacen/crear/<?php echo $idcomp; ?>/#2" title="Crear" class="crear btn btn-danger btn-sm">
                    <i class="fa fa-plus fa-fw"></i>
                    Crear <?php echo $this->titulos[$idcomp] ?>
                </a>
            </div>
        </div>
        <div class="row page-header-content">
            ...
            <form class="ocform form-inline">
				<div class="onsel form-inline hidden">
					<a class="btn btn-primary btn-sm enviar_todos" href="#">
				...
				<div class="nosel">
					<input type="hidden" name="tipo" id="tipo" value="<?php echo $idcomp; ?>">
					...
					<div class="form-group">
						<?= form_dropdown('sucursal', $sucursales, '', array('class' => 'form-control input-sm', "id"=> "sucursal")); ?>
					</div>
					<div class="form-group">
