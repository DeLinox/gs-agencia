...
$(document).on('ready', function () {
    baseurl = $("#baseurl").val();
    var url = baseurl + 'Cliente/listado?json=true';
    var $table;
    var seleccionados;
    var procesados = 0;
    ...
    function botones(id,estado,mail,$ar){
       ...
       html = `
        <span class='show_enviar '><a href='{baseurl}Cliente/crear/{id}' class='btn btn-primary btn-sm edit'><span class='glyphicon glyphicon-edit'></span></a></span> 
        <span class='show_correo '><a href='{baseurl}Cliente/eliminar/{id}' class='btn btn-danger btn-sm delete'><span class='glyphicon glyphicon-trash'></span></a></span>`;
    ...
    $('#btn-report-excel').on('click',function(){
        window.location.href = baseurl+"Cliente/reporte_excel/?search="+$('#filtro').val();
