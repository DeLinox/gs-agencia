...
$(document).on('ready', function() {
    ...
    function botones(id,$ar) {
        html = `<a href='{baseurl}Planilla/emp_crear/{id}' class='editar btn btn-primary btn-xs' title='Editar Empleado'><span class='glyphicon glyphicon-pencil'></span></a>
                <a href='{baseurl}Planilla/emp_eliminar/{id}' class='eliminar btn btn-danger btn-xs' title='Eliminar Empleado'><span class='glyphicon glyphicon-trash'></span></a>`;        
