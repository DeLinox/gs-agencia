...
$(document).on('ready', function () {
	...
	$('#btn-report-excel').on('click',function(){
		...
		window.location.href = baseurl+"Reporte/reporte_excel_proveedores/?desde="+$('#desde').val()+"&hasta="+$('#hasta').val()+"&comprobantes="+$('#comprobantes').val()+"&proveedor="+$('#proveedor').val()+"&search="+$('#filtro').val();
...
function llenarTabla() {
    ...
    $.ajax({
        dataType: "json",
        method: "POST",
        url: baseurl + "Reporte/getResumenproveedor",
        data: form.serialize(),
