$(document).ready(function(){
	...
	$('.informeGastos').click(function(){
        $(location).attr('href',baseurl+"Reporte/excel_informeGastos?search="+$('input[name="search"]').val()+"&desde="+$('input[name="desde"]').val()+"&hasta="+$('input[name="hasta"]').val());
    })
