...
$(document).on('ready', function () {
	...
	$('#btn-report-excel').on('click',function(){
		...
		window.location.href = baseurl+"Reporte/reporte_ventas_empleados/?desde="+$('#desde').val()+"&hasta="+$('#hasta').val()+"&comprobantes="+$('#comprobantes').val()+"&moneda="+$('#moneda').val()+"&search="+$('#filtro').val()+"&usuario="+$('select[name="usuario"]').val();
...
function llenarTabla() {
    ...
    $.ajax({
        dataType: "json",
        method: "POST",
        url: baseurl + "Reporte/getResumenEmpleado",
        data: form.serialize(),
