...
$(document).on('ready', function () {
    baseurl = $("#baseurl").val();
    var url = baseurl + 'Baja/Listado?json=true';
    var $table;
    var seleccionados;
    ...
    function botones(id,estado,$ar){
       ...
       html = `<div class='dropdown'>
          ...
          <ul class='dropdown-menu'>
            <li class="show_editar oculto"><a href='{baseurl}Baja/edit/{id}' class='editar'><span class='glyphicon glyphicon-pencil'></span> Editar</a></li>
            <li class="show_xml oculto"><a href='{baseurl}Baja/getxml/{id}'><span class='glyphicon glyphicon-menu-hamburger'></span> Comprobante digital</a></li>
            <li class="show_cdr oculto"><a href='{baseurl}Baja/getcdr/{id}'><span class='glyphicon glyphicon-cloud-download'></span> Constancia Sunat</a></li>
          </ul>
        </div>
        <span class='show_enviar oculto'><a href='{baseurl}Baja/enviarSunat/{id}' class='btn btn-primary btn-sm enviar'><span class='glyphicon glyphicon-refresh'></span></a></span>`;
