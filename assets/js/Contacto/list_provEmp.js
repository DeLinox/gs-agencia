...
$(document).on('ready', function() {
    ...
    function botones(id, permisos, $ar) {
        html = `
        <span class="show_editar oculto"><a href='{baseurl}Contacto/crear_provEmp/{id}' class='btn btn-success btn-sm editar'><span class='glyphicon glyphicon-pencil'></span></a></span>`;
