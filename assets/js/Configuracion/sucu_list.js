...
$(document).on('ready', function () {
    baseurl = $("#baseurl").val();
    var url = baseurl + 'Configuracion/sucursales?json=true';
    var $table;
    var seleccionados;
    var procesados = 0;
    ...
    function botones(id,estado,mail,$ar){
       ...
       html = `
        <span class='show_enviar oculto'><a href='{baseurl}Producto/crear/{id}' class='btn btn-primary btn-sm edit'><span class='glyphicon glyphicon-edit'></span></a></span> 
        <span class='show_correo oculto'><a href='{baseurl}Producto/eliminar/{id}' class='btn btn-danger btn-sm delete'><span class='glyphicon glyphicon-trash'></span></a></span>`;
