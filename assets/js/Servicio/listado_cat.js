...
$(document).on('ready', function () {
    baseurl = $("#baseurl").val();
    var url = baseurl + 'Producto/categorias?json=true';
    var $table;
    var seleccionados;
    var procesados = 0;
    ...
    function botones(id,estado,mail,$ar){
       ...
       html = `
        <span class='show_enviar '><a href='{baseurl}Producto/crear_cat/{id}' class='btn btn-primary btn-sm edit'><span class='glyphicon glyphicon-edit'></span></a></span> 
        <span class='show_correo '><a href='{baseurl}Producto/eliminar_cat/{id}' class='btn btn-warning btn-sm delete'><span class='glyphicon glyphicon-remove'></span></a></span>`;
    ...
    $('#btn-report-excel').on('click',function(){
        window.location.href = baseurl+"Producto/reporte_categoria/?categoria="+$('#categoria').val()+"&search="+$('#filtro').val();
